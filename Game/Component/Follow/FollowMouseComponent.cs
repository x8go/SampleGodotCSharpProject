...
/// <summary>
/// 마우스 추적 컴포넌트 - 엔티티가 마우스 커서 위치를 따라가도록 합니다.
/// Main.tscn의 플레이어나 다른 엔티티에 추가하여 마우스 기반 이동을 구현합니다.
/// 마우스까지의 거리에 비례하여 속도가 조절되므로 자연스러운 추적 동작을 제공합니다.
/// </summary>
public partial class FollowMouseComponent : BaseComponent, IFollowComponent
{
	/// <summary>
	/// 이 컴포넌트가 부착된 부모 PhysicsBody2D (플레이어, 좀비 등)
	/// </summary>
